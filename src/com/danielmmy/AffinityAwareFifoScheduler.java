...
public class AffinityAwareFifoScheduler extends AffinityAwareScheduler {

	public AffinityAwareFifoScheduler(List<Task> tasks, List<Integer> arrivalOrder, List<Node> infrastructure,double[][][] AFFINITY3, AffinityType affinityType, int maxAge) {
		super(tasks, arrivalOrder, infrastructure, AffinityAwareFifoScheduler.class.getSimpleName() ,AFFINITY3, affinityType, maxAge);
